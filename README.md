...
# Requirements #
I haven't tested this on anything older than Emacs 24, so I think it's safe to say that that's the minumum version required. You might also need LLVM and Clang if you want C++ completion, and Jedi if you want Python completion.
